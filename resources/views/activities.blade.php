                ...
                <form class="form row" action="{{route('activities.dateqty')}}">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="date" class="form-control form-control-sm" id="activity_date" placeholder="Fecha de Actividad" name="activity_date" required autofocus value="{{($_GET['activity_date']) ?? ''}}">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control form-control-sm" id="qty_people" min="1" name="qty_people" placeholder="Cantidad de personas" required autofocus value="{{($_GET['qty_people']) ?? ''}}">
                                ...
                                @foreach ($activities as $activity )
                                    <tr class="bg-gray-100 border-b">
                                        ...
                                        <td class="text-center">
                                            <a href="#" onclick="showActivity('{{$activity->id}}')" id="showMore" class="btn btn-link btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">Ver más</button>
                                            <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn btn-primary btn-sm">Comprar</button>
                                        </td>
